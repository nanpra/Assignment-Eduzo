...
{
    public class PatternsStartScreenUIAnimations : MonoBehaviour
    {
        ...
        private IEnumerator PatternsDelayAnimation()
        {
            ...
            seq.Append(
                practiceModeButton.DOAnchorPos(practiceModeButtonOriginalPos, patternsAnimDuration)
                    ...
                    .OnStart(() => PatternsAudioManager.Instance.PlaySFX("Slide"))
            );
            ...
            seq.OnComplete(() => PatternsAudioManager.Instance.PlayBgMusic("BgMusic"));
        }
    }
}