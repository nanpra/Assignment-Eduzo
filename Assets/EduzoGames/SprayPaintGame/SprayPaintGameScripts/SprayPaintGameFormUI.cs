...
{
    public class SprayPaintQuestionFormUI : MonoBehaviour
    {
        public static SprayPaintQuestionFormUI Instance;
        ...
        private readonly List<SprayPaintQuestionPanel> panels = new();
        ...
        private void AddPanel()
        {
            ...
            var panel = go.GetComponent<SprayPaintQuestionPanel>();
            panels.Add(panel);
        ...
        private void SlideTo(int newIndex, bool fromRight)
        {
            ...
            SprayPaintAudioManager.Instance.PlaySFX("Slide");
        ...
        private void OnConfirm()
        {
            ...
            List<SprayPaintQuestionData> finalQuestions = new();
            ...
            SprayPaintGameManager.Instance.LoadGeneratedQuestions_Backend(finalQuestions);
            SprayPaintUIManager.Instance.StartGameplayFromForm();
