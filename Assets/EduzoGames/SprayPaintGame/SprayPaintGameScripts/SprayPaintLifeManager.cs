...
{
    public class SprayPaintLifeManager : MonoBehaviour
    {
        public static SprayPaintLifeManager Instance;
        ...
        {
            if (SprayPaintUIManager.Instance.CurrentMode == SprayPaintGameMode.Practice)
                return;
        ...
        public void ResetLives()
        {
            ...
            for (int i = 0; i < totalLives; i++)
            {
                ...
                lifeFilledImages[i].color = new(f.r, f.g, f.b, 1);

                lifeEmptyImages[i].gameObject.SetActive(true);
                var e = lifeEmptyImages[i].color;
                lifeEmptyImages[i].color = new(e.r, e.g, e.b, 0);
            }
        }
        ...
        {
            return lifeCurrentIndex < totalLives;
        }
    }
}