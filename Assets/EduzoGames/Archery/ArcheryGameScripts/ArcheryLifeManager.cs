...
{
    public class ArcheryLifeManager : MonoBehaviour
    {
        public static ArcheryLifeManager Instance;
        ...
        {
            if (ArcheryUIManager.Instance.CurrentMode == ArcheryGameMode.Practice)
                return;
