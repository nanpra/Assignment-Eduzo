...
{
    public class ArcheryGameStartAnimation : MonoBehaviour
    {
        ...
        private IEnumerator PatternsDelayAnimation()
        {
            ...
            seq.Append(
                practiceModeButton.DOAnchorPos(practiceModeButtonOriginalPos, patternsAnimDuration)
                    ...
                    .OnStart(() => ArcheryAudioManager.Instance.PlaySFX("Slide"))
            );
            ...
            seq.OnComplete(() => ArcheryAudioManager.Instance.PlayBgMusic("BgMusic"));
        }
    }
}