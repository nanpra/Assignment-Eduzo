...
{
    public class RoboRideStartScreenUIAnimations : MonoBehaviour
    {
        ...
        private IEnumerator PatternsDelayAnimation()
        {
            ...
            seq.Append(
                practiceModeButton.DOAnchorPos(practiceModeButtonOriginalPos, patternsAnimDuration)
                    ...
                    .OnStart(() => RoboRideAudioManager.Instance.PlaySFX("Slide"))
            );
            ...
            seq.OnComplete(() => RoboRideAudioManager.Instance.PlayBgMusic("BgMusic"));
        }
    }
}