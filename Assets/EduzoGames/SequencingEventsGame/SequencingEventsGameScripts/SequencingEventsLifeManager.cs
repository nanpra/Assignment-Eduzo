...
{
    public class SequencingEventsLifeManager : MonoBehaviour
    {
        public static SequencingEventsLifeManager Instance;
        ...
        {
            if (SequencingEventsUIManager.Instance.CurrentMode == SequencingEventsGameMode.Practice)
                return;
