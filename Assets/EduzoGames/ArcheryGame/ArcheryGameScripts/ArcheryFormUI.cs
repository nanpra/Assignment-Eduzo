...
{
    public class ArcheryQuestionFormUI : MonoBehaviour
    {
        public static ArcheryQuestionFormUI Instance;
        ...
        private readonly List<ArcheryQuestionPanel> panels = new();
        ...
        private void AddPanel()
        {
            ...
            var panel = go.GetComponent<ArcheryQuestionPanel>();
            panels.Add(panel);
        ...
        private void SlideTo(int newIndex, bool fromRight)
        {
            ...
            ArcheryAudioManager.Instance.PlaySFX("Slide");
        ...
        private void OnConfirm()
        {
            ...
            List<ArcheryQuestionData> finalQuestions = new();
            ...
            ArcheryGameManager.Instance.LoadGeneratedQuestions_Backend(finalQuestions);
            ArcheryUIManager.Instance.StartGameplayFromForm();
